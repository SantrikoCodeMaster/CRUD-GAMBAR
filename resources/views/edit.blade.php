                ...
                <div class="container-fluid">
                    ...
                    <form action="/edits" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_produk" name="nama_produk" value="{{$toko->nama_produk}}"
                                aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="harga_produk" name="harga_produk" value="{{$toko->harga_produk}}"
                                aria-describedby="emailHelp">
                        ...
                        <div class="mb-3">
                            <select class="form-select" aria-label="Default select example" id="datas" name="id_barang">
                                <option>Open Drop Down</option>
                                @foreach ($matakuliah as $mk)
                                <option {{ ($toko->id_barang == $mk->id) ? 'selected' : ''}} value="{{$mk->id}}">{{$mk->nama_barang}}</option>
                                @endforeach
                            </select>
                        </div>
